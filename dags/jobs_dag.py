...
config = {
    'dag_id_1': {'schedule_interval': timedelta(minutes=1),
                 'start_date': datetime(2018, 11, 11),
                 'table_name': 'table_name_1'},
    'dag_id_2': {'schedule_interval': timedelta(minutes=1),
                 'start_date': datetime(2018, 11, 11),
    ...
    def create_dag():
        with DAG(
            ...
            task_check_table_exist = BranchPythonOperator(
                task_id='branch_check_table_exist',
            ...
            task_log_info >> task_check_table_exist >> [task_skip_table_creation, task_create_table]\
            >> task_insert_new_row >> task_query_the_table
        return dag
